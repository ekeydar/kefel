...
app.controller('KefelController', ['$scope', '$document', '$filter', 'UsersDB', 'KefelConfig',
    function ($scope, $document, $filter, UsersDB, KefelConfig) {
        function Question(index, questions, kind) {
            Question.prototype.genNum = function () {

                return kind.minNumber + Math.floor(Math.random() * kind.maxNumber);
            }
            ...
            Question.prototype.toString = function () {
                return this.num1 + kind.symbol + this.num2;
            }
            ...
            this.answer = $scope.kind.getAnswer(this.num1, this.num2)
        ...
        $scope.start = function () {
            ...
            for (var i = 1; i <= $scope.numQuestions; i++) {
                var newq = new Question(i, $scope.questions, KefelConfig.kind);
